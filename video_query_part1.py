...
for video in video_list:
    ...
    if args.f == features[0]:
        ...
        scores = sliding_window(x,w, euclidean_norm_mean)
    elif args.f == features[1]:
        x = search.get_temporaldiffs_for(video)
        scores = sliding_window(x,w, euclidean_norm)
        ...
        scores = sliding_window(x[:,:availableLength,:],w[:,:availableLength,:], euclidean_norm_mean)
    elif args.f == features[4]:
